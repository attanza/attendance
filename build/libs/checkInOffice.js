...
exports.checkInOffice = void 0;
var axios_1 = __importDefault(require("axios"));
var moment_1 = __importDefault(require("moment"));
var form_data_1 = __importDefault(require("form-data"));
var getToken_1 = require("./getToken");
var randTime_1 = require("./randTime");
var checkInOffice = function (NIK, PASSWORD) { return __awaiter(void 0, void 0, void 0, function () {
    var token, today, hour, minute, seconds, time, data, config, resp, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                hour = '07';
                minute = (0, randTime_1.randTime)(37, 57);
...
exports.checkInOffice = checkInOffice;
